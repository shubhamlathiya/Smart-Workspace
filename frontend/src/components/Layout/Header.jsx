                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-white font-semibold">
                    {user?.name?.charAt(0).toUpperCase()}
                                ...
                                {/* Dropdown menu */}
                                <div
                                    className="absolute right-0 top-12 w-48 bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                    <div className="py-2">
                                        <button
                                            onClick={handleProfileClick}

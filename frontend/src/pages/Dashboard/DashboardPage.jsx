            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
                  <div className="text-2xl font-bold text-blue-400 mb-1">{stats.tasksByStatus.todo}</div>
                  <div className="text-blue-300 text-sm">To Do</div>
                </div>
                <div className="text-center p-4 bg-yellow-500/10 rounded-lg border border-yellow-500/20">
                  <div className="text-2xl font-bold text-yellow-400 mb-1">{stats.tasksByStatus.inProgress}</div>
                  <div className="text-yellow-300 text-sm">In Progress</div>
                </div>
                <div className="text-center p-4 bg-orange-500/10 rounded-lg border border-orange-500/20">
                  <div className="text-2xl font-bold text-orange-400 mb-1">{stats.tasksByStatus.review}</div>
                  <div className="text-orange-300 text-sm">In Review</div>
                </div>
                <div className="text-center p-4 bg-green-500/10 rounded-lg border border-green-500/20">
                  <div className="text-2xl font-bold text-green-400 mb-1">{stats.tasksByStatus.completed}</div>
                ...
                {stats.overdueTasks > 0 && (
                    <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
                      ...
                      <p className="text-red-300 text-sm">
                        You have {stats.overdueTasks} overdue task{stats.overdueTasks > 1 ? 's' : ''}. Review them soon.
                      </p>
                    </div>
                )}
                ...
                {stats.tasksByStatus.todo > 0 && (
                    <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                      ...
                      <p className="text-blue-300 text-sm">
                        {stats.tasksByStatus.todo} task{stats.tasksByStatus.todo > 1 ? 's' : ''} waiting to be started.
                      </p>
                    </div>
                )}
                ...
                {stats.completionRate >= 80 && (
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                      ...
                      <p className="text-green-300 text-sm">
                        You're doing great! {stats.completionRate}% of your tasks are completed.
                      </p>
                    </div>
                )}
              </div>

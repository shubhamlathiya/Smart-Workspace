                            ...
                            <div key={invitation._id} className="glass-card p-6">
                                <div className="flex items-center justify-between">
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center space-x-4 text-sm">
                                            <span className="text-white/60">
                                                Role: <span className="text-white font-medium capitalize">{invitation.role}</span>
                                            </span>
                                            <span className="text-white/60">
                                    ...
                                    <div className="flex space-x-3">
                                        ...
                                        <button className="px-4 py-2 bg-white/10 text-white font-semibold rounded-lg hover:bg-white/20 transition-all duration-200">
                                            Decline
                                        </button>
                                    </div>
                                </div>
